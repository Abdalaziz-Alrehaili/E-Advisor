...
function Plan({ user }) {
  ...
  return (
    <div className="container plan-page-container shadow-lg bg-white rounded p-4 my-5">
      ...
      {/* START OF THE ROW GRID */}
      <div className="row">
        
        {/* --- COLUMN 1: col-4 for Recommendations --- */}
        <div className="col-4">
          <div className="mb-5 p-4 rounded shadow-sm border bg-white h-100">
            ...
            <div>
                ...
                <div className="d-flex flex-column gap-3">
                  {recommendations.length === 0 ? (
                    <div className="text-center text-muted mt-4">
                      <small>No recommendations available for this semester.</small>
                    </div>
                  ) : (
              ...
              <div className="fw-bold text-center mt-3 p-2 rounded-pill w-100" 
        ...
        {/* --- COLUMN 2: col-8 for the Roadmap --- */}
        <div className="col-8">
